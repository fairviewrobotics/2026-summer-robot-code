...
public class SwerveModule extends SubsystemBase {
  ...
  private final TalonFXConfiguration turningConfig = new TalonFXConfiguration();
  private final CANcoderConfiguration turningEncoderConfig = new CANcoderConfiguration();
  ...
  public void setAbsoluteEncoderOffset(double offset) {
    turningEncoderConfig.MagnetSensor.MagnetOffset = Units.radiansToRotations(offset);
