...
public class FieldConstants {
    ...
    public static final Pose2d START_POINT = new Pose2d(1.783, 1.79, Rotation2d.kZero);
    public static final Pose2d TOP_RIGHT_POINT = new Pose2d(2.783,1.79, Rotation2d.kCCW_90deg);
    public static final Pose2d BOTTOM_RIGHT_POINT = new Pose2d(2.783,0.79, Rotation2d.k180deg);
    public static final Pose2d BOTTOM_LEFT_POINT = new Pose2d(1.783,0.79, Rotation2d.kCCW_90deg);
